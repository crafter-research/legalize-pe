...
Que, el numeral 4 del artículo 205 del Nuevo Código Procesal Penal, regula el procedimiento de control de identificación policial en caso que no sea posible la exhibición del documento de identidad; resultando necesario que se ampl�e el plazo para la plena identificación de los extranjeros y se establezca disposiciones que aseguren el desarrollo de un procedimiento más ágil y ordenado para el control de identidad policial de los extranjeros;
