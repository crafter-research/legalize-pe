...
const LEYES_BATCH4: LawDefinition[] = [
  // Leyes Orgánicas
  {
    ...
    sumilla: 'Regula la organización y funcionamiento del Tribunal Constitucional',
  },
  {
    id: 'ley-26520',
    ...
    sumilla: 'Regula la Defensoría del Pueblo como órgano constitucional autónomo',
  },
  {
    id: 'dley-26123',
  ...
  // Ambiental
  {
    ...
    sumilla: 'Crea el SEIA como sistema único para identificar impactos ambientales',
  },
  ...
  },
  {
    ...
    sumilla: 'Establece mecanismos para prevenir y sancionar la violencia contra las mujeres',
  },
  ...
  // Descentralización
  {
    ...
    materias: ['descentralización', 'gobiernos regionales', 'gobiernos locales'],
